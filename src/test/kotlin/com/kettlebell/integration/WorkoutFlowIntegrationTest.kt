...
class WorkoutFlowIntegrationTest : StringSpec({
    ...
    "Integration test: Complete workout flow end-to-end" {
        runBlocking {
            ...
            val mockPerformance = ActualPerformance(
            ...
            val workoutRequestUpdate = TelegramUpdate(
                update_id = 1,
            ...
            val startWorkoutCallback = TelegramUpdate(
                update_id = 2,
            ...
            val finishWorkoutCallback = TelegramUpdate(
                update_id = 3,
                callback_query = TelegramCallbackQuery(
                    id = "callback2",
                    from = TelegramUser(id = userId, first_name = "Test", username = "testuser"),
            ...
            val feedbackUpdate = TelegramUpdate(
                update_id = 4,
                message = TelegramMessage(
                    message_id = 4,
                    from = TelegramUser(id = userId, first_name = "Test", username = "testuser"),
